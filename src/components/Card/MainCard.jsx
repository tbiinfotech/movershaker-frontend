...
const MainCard = (props) => {
  const { key, isOption, title, children, cardClass, optionClass, cardName, id, remove, showAction } = props;
  ...
  const cardRemoveHandler = async () => {
    const response = await axios.delete(`${import.meta.env.VITE_SERVER_URL}/api/${cardName}/${id}`, {
      headers: {
